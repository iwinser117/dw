...
function multiplicar(){
    ...
    document.getElementById(`resultadoMultiplicar`).innerHTML = `resultado de la multiplicacion es : ${resultadoResta}`;
    console.log(`resultado de la resta es : ${resultadoMultiplicar}`);
}
